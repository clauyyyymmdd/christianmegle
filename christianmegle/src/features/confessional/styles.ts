...
export const screenStyles: Record<string, React.CSSProperties> = {
  ...
  asciiWelcome: { color: 'var(--amber)', fontSize: '0.7rem', lineHeight: 1.3, margin: 0, textShadow: '0 0 15px rgba(255, 176, 0, 0.5)' },
  asciiPending: { color: 'var(--amber-dim)', fontSize: '0.7rem', lineHeight: 1.3, margin: 0 },
  asciiError: { color: 'var(--crimson)', fontSize: '0.7rem', lineHeight: 1.3, margin: 0, textShadow: '0 0 15px rgba(139, 30, 38, 0.5)' },
  asciiWaiting: { color: 'var(--amber)', fontSize: '0.9rem', lineHeight: 1.2, margin: 0, textShadow: '0 0 15px rgba(255, 176, 0, 0.5)' },
  ...
  priestNameHighlight: { color: 'var(--amber-bright)', textShadow: '0 0 20px rgba(255, 176, 0, 0.8)' },
