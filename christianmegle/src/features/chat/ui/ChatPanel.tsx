...
const styles: Record<string, React.CSSProperties> = {
  chatColumn: { width: '320px', flexShrink: 0, display: 'flex', flexDirection: 'column', background: 'var(--bg-chat)' },
  chatHeader: { padding: '0.75rem 1rem', borderBottom: '1px solid var(--border-subtle)', flexShrink: 0 },
  ...
  chatMessageSelf: { alignSelf: 'flex-end', background: 'var(--bg-chat-self)', border: '1px solid var(--border-chat-self)' },
  chatMessageOther: { alignSelf: 'flex-start', background: 'var(--bg-chat-other)', border: '1px solid var(--border-chat-other)' },
  ...
  chatInputContainer: { display: 'flex', gap: '0', borderTop: '1px solid var(--border-subtle)', flexShrink: 0 },
  chatInput: { flex: 1, padding: '0.7rem 0.85rem', fontFamily: 'var(--font-terminal)', fontSize: '0.8rem', background: 'var(--bg-input)', border: 'none', borderRight: '1px solid var(--border-subtle)', color: 'var(--ivory)', outline: 'none' },
